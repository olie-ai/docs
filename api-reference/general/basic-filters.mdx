...
<Tip>
Para necessidades mais complexas de filtragem, use o sistema de [Busca Avançada](/api-reference/general/advanced-search) que oferece operadores relacionais, lógicos e filtros em relacionamentos.
</Tip>
