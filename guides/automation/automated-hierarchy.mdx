...
<Info>
O projeto pai é o projeto que acionou o gatilho da automação. Se você definir outros [projetos alvo](/guides/automation/anatomy#em-quais-projetos-cada-componente-age) na ação, a estrutura é criada em cada um deles.
</Info>
