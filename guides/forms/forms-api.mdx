...
São 21. O nome na tabela é o valor literal de `type`. O formato do `answer` de cada um está em [Formato da resposta de cada campo](/guides/forms/answers-format).
