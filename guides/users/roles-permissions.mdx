...
<Accordion title="Categorias de permissões" icon="layer-group">
  ...
  - **Canais**: Visualizar, criar, editar e arquivar os canais de conversa dos projetos
  - **Integrações**: Visualizar, criar, editar e remover integrações, como o WhatsApp
</Accordion>
</AccordionGroup>

<Note>
Canais e integrações estão disponíveis para todas as empresas, mas cada pessoa só consegue usá-los se o papel dela tiver as permissões dos grupos **Canais** e **Integrações**. O papel **Property** já tem todas; nos papéis criados pela sua empresa, você precisa marcá-las.
</Note>
